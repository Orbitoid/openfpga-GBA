...
if {[catch {qexec "quartus_sta -t scripts/sta_custom_report.tcl ap_core_analogizer"} result]} {
...
foreach f {build_output/reports/ap_core_analogizer.sta.paths_setup.rpt
           build_output/reports/ap_core_analogizer.sta.paths_hold.rpt
           build_output/reports/ap_core_analogizer.sta.clock_summary.rpt} {
    if {[file exists $f]} {
